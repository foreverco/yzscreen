<template>
  <div class="home-box">
    ...
    <div class="main-box">
      <div class="top-box">
        <div class="left-box">
          <div class="left-top">数据信息</div>
          <div class="left-bot">数据信息</div>
        </div>
        <div class="mid-box">
          <p class="mid-title">考勤成功提示</p>
          <div>{{redata || "暂无考勤数据"}}</div>
        </div>
        <div class="right-box">
          <div class="right-top">数据信息</div>
          <div class="right-bot">数据信息</div>
        </div>
      </div>
      <div class="bot-box">
        <div class="bot-left">
...
export default {
  ...
  methods: {
    ...
    setOnmessageMessage(event) {
      ...
      //     );
      // document.getElementById("aaa").innerHTML = JSON.stringify(
      //   obj.data,
      //   null,
      //   4
      // );
