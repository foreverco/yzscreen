    ...
    <div class="main-box">
      <div class="top-box">
        <div class="left-box">
          <div class="left-top">
            <!-- <span>请假信息</span> -->
            <div class="chart-box">
              <Echars :option="hosptaloption"></Echars>
            </div>
          </div>
          <div class="left-bot">
            <!-- <span>加班信息</span> -->
      ...
      <div class="bot-box">
        <div class="bot-left">
          ...
          <div class="chart-box">
            <Echars :option="leftOptionyb"></Echars>
          </div>
        </div>
        <div class="bot-right">
          <div class="chart-box">
...
export default {
  ...
  methods: {
    ...
    websocketonmessage(e) {
      ...
      let ispush = this.CardPartsStatisticsList.filter(item => {
        return (
      ...
      if (ispush.length === 0) {
        ...
        this.CardPartsStatisticsList.unshift(obj);
      }
      console.log(this.CardPartsStatisticsList);
    },
    websocketsend(Data) {
      //数据发送
      console.log(Data);
